...
urlpatterns = [
    ...
    path('tareas-years/<int:year_inicio>/<year_fin>/',views.tareas_years,name='tareas_years'),
    path('comentario/<int:id_proyecto>/',views.ultimo_usuario,name='ultimo_usuario'),
    path('comentario-palabra/<str:palabra>/<int:year>/',views.comentarios_palabra_year,name='comentario_palabra')
]
